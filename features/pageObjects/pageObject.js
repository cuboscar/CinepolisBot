export
    ...
    redirect() {
        ...
        browser.pause(8000); //Due to additional add
    }
    typeCity(city) {
        this.city = city;
...
export
    ...
    constructor(URL, sliderLeftSelector, sliderRightSelector, sliderRangeSelector, timeSelector) {
        ...
        this.timeInit = ""
        this.timeFinish = ""
        this.MoviesTag = '.row.tituloPelicula.ng-scope'
        this.movies = []
    }
    timeStamp(hour) {
        switch (hour) {
    ...
    selectHour(startHour, endHour) {
        this.timeInit = startHour
        this.timeFinish = endHour
...
export
    class PageMovie {
    constructor(CiudadesTagSelector) {
        this.CiudadesTagSelector = '#uniform-cmbCiudadesHorario>span'
    }
